    ...
    public IMessage? Parse(ReadOnlyMemory<byte> data)
    {
        try
        {
            ...
            IMessage? message = messageType switch
            {
                ...
                MessageType.SyncStep1 => JsonSerializer.Deserialize<SyncStep1Message>(json, SourceGenOptions),
                MessageType.SyncStep2 => JsonSerializer.Deserialize<SyncStep2Message>(json, SourceGenOptions),
                MessageType.Delta => JsonSerializer.Deserialize<DeltaMessage>(json, SourceGenOptions),
                MessageType.DeltaBatch => JsonSerializer.Deserialize<DeltaBatchMessage>(json, SourceGenOptions),
                MessageType.DeltaBatchChunk => JsonSerializer.Deserialize<DeltaBatchChunkMessage>(json, SourceGenOptions),
