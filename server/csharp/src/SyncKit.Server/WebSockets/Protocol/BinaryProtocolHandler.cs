...
public class BinaryProtocolHandler : IProtocolHandler
{
    ...
    private static readonly Dictionary<MessageTypeCode, MessageType> CodeToType = new()
    {
        ...
        { MessageTypeCode.SYNC_STEP1, MessageType.SyncStep1 },
        { MessageTypeCode.SYNC_STEP2, MessageType.SyncStep2 },
        { MessageTypeCode.DELTA, MessageType.Delta },
        { MessageTypeCode.DELTA_BATCH, MessageType.DeltaBatch },
        { MessageTypeCode.DELTA_BATCH_CHUNK, MessageType.DeltaBatchChunk },
    ...
    private static readonly Dictionary<MessageType, MessageTypeCode> TypeToCode = new()
    {
        ...
        { MessageType.SyncStep1, MessageTypeCode.SYNC_STEP1 },
        { MessageType.SyncStep2, MessageTypeCode.SYNC_STEP2 },
        { MessageType.Delta, MessageTypeCode.DELTA },
        { MessageType.DeltaBatch, MessageTypeCode.DELTA_BATCH },
        { MessageType.DeltaBatchChunk, MessageTypeCode.DELTA_BATCH_CHUNK },
    ...
    public IMessage? Parse(ReadOnlyMemory<byte> data)
    {
        try
        {
            ...
            IMessage? message = messageType switch
            {
                ...
                MessageType.SyncStep1 => JsonSerializer.Deserialize<SyncStep1Message>(json, JsonOptions),
                MessageType.SyncStep2 => JsonSerializer.Deserialize<SyncStep2Message>(json, JsonOptions),
                MessageType.Delta => JsonSerializer.Deserialize<DeltaMessage>(json, JsonOptions),
                MessageType.DeltaBatch => JsonSerializer.Deserialize<DeltaBatchMessage>(json, JsonOptions),
                MessageType.DeltaBatchChunk => JsonSerializer.Deserialize<DeltaBatchChunkMessage>(json, JsonOptions),
