...
public class MessageTypeConverter : JsonConverter<MessageType>
{
    ...
    private static readonly Dictionary<string, MessageType> _stringToEnum = new()
    {
        ...
        ["sync_step1"] = MessageType.SyncStep1,
        ["sync_step2"] = MessageType.SyncStep2,
        ["delta"] = MessageType.Delta,
        ["delta_batch"] = MessageType.DeltaBatch,
        ["delta_batch_chunk"] = MessageType.DeltaBatchChunk,
        ["ack"] = MessageType.Ack,
    ...
    private static readonly Dictionary<MessageType, string> _enumToString = new()
    {
        ...
        [MessageType.SyncStep1] = "sync_step1",
        [MessageType.SyncStep2] = "sync_step2",
        [MessageType.Delta] = "delta",
        [MessageType.DeltaBatch] = "delta_batch",
        [MessageType.DeltaBatchChunk] = "delta_batch_chunk",
        [MessageType.Ack] = "ack",
